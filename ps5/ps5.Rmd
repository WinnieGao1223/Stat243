...
```
*Ans:*We have 16 digits of accuracy, since x=z+1e12, 1e12*1e-16=1e-4, so it's only accurate to 4 decimal places. Therefore, when we calculate the variance, we cannot keep the original accuracy.
