...
ggplot(result3, aes(x=Words, y=Count, group=Candidate))+geom_bar(aes(fill = Candidate), position = "dodge", stat="identity") + theme(axis.text.x = element_text(angle = 90, hjust = 1)) + labs(x='Specified Words')
```
